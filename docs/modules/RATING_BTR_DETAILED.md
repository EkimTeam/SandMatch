...
## Связь с BP рейтингом

BTR рейтинг используется как **начальный рейтинг** для игроков при первом участии в турнирах системы BP (Beach Play).

**Примечание:** Автоматическая конвертация BTR → BP в текущей версии не реализована. Игроки с BTR рейтингом получают начальный BP рейтинг при первом участии в турнире, после чего BP рейтинг рассчитывается независимо по результатам матчей.
