...
# Thread-local storage для transaction_id
...
class RegistrationService:
    ...
    def leave_pair(registration: TournamentRegistration):
        ...
        # Устанавливаем transaction_id для передачи в сигнал
        RegistrationService._set_transaction_id_on_instance(registration, transaction_id)
        ...
        if partner_reg:
            ...
            # Устанавливаем transaction_id для передачи в сигнал
            RegistrationService._set_transaction_id_on_instance(partner_reg, transaction_id)
            # Сигнал post_save автоматически вызовет пересчёт
            partner_reg.save()
    ...
    def cancel_registration(registration: TournamentRegistration):
        ...
        # Устанавливаем transaction_id для передачи в сигнал post_delete
        RegistrationService._set_transaction_id_on_instance(registration, transaction_id)
