...
1. **Новый турнир** — при создании турнира (для подписчиков)
2. **Напоминание о турнире** — за 24 часа до начала (для участников)
3. **Результат матча** — после внесения результата (для участников матча)

### 📖 Полная инструкция

**См. подробную документацию:** [docs/TELEGRAM_NOTIFICATIONS_SETUP.md](../../docs/TELEGRAM_NOTIFICATIONS_SETUP.md)

В инструкции:
- ✅ Настройка Redis и Celery
- ✅ Запуск локально и на проде
...
- [x] Уведомления о новых турнирах
- [x] Напоминания о начале турнира
- [x] Уведомления о результатах матчей
- [ ] Поиск пары для игры
